...
PUTCHAR_PROTOTYPE
{
  /* Place your implementation of fputc/__io_putchar here */
  /* e.g. write a character to the serial port and Loop until the end of transmission */
  while (HAL_OK != HAL_UART_Transmit(DBG_PORT, (uint8_t *) &ch, 1, 1000))
  {
    ;
  }
  return ch;
...
GETCHAR_PROTOTYPE
{
  /* Place your implementation of fgetc/__io_getchar here */
  /* e.g. readwrite a character to the USART1 and Loop until the end of transmission */
  uint8_t ch = 0;
  while (HAL_OK != HAL_UART_Receive(DBG_PORT, (uint8_t *)&ch, 1, 1000))
  {
    ;
  }
  return ch;
